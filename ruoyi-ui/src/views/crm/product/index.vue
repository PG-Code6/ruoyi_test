    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px" label-position="right">
        <el-row>
          <el-col :span="12">
            <el-form-item label="产品编码" prop="prodCode">
              <el-select v-model="form.prodCode" placeholder="请选择产品编码">
                <el-option
                  v-for="item in proCodeList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value">
                </el-option>
          ...
          <el-col :span="12">
            <el-form-item label="属性编号" prop="prodAttr">
              <el-select v-model="form.prodAttr" placeholder="请选择属性编号">
                <el-option
                  v-for="item in prodAttrList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value">
                </el-option>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="类型编号" prop="prodAttr">
              <el-select v-model="form.prodType" placeholder="请选择类型编号">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="品牌编号" prop="prodBrand">
              <el-select v-model="form.prodBrand" placeholder="请选择品牌编号">
                <el-option
                  v-for="item in prodBrandList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value">
                </el-option>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="单位编号" prop="prodUnit">
              <el-select v-model="form.prodUnit" placeholder="请选择单位编号">
                <el-option
                  v-for="item in prodUnitList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value">
                </el-option>
          ...
          <el-col :span="12">
            <el-form-item label="权限编号" prop="prodPerm">
              <el-select v-model="form.prodPerm" placeholder="请选择权限编号">
                <el-option
                  v-for="item in prodPermList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value">
                </el-option>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="成本单价" prop="costPrice">
              <el-input step="0.01" type="number" v-model.number="form.costPrice" placeholder="请输入成本单价" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="增值税税率" prop="vatRate">
              <el-input :max="100" :min="0" type="number" style="width: 200px;" v-model.number="form.vatRate" placeholder="请输入增值税税率(%)" @input="autoPrice(form)">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="销售单价(含税)" prop="inclTaxPrice">
              <el-input step="0.01" type="number" v-model.number="form.inclTaxPrice" placeholder="请输入销售单价(含税)" @input="autoPrice(form)"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="销售单价(不含税)" prop="exclTaxPrice">
              <el-input v-model="form.exclTaxPrice" placeholder="销售单价(不含税)" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="税额" prop="taxAmount">
              <el-input v-model="form.taxAmount" placeholder="税额" disabled/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="售价毛利" prop="grossProfit">
              <el-input v-model="form.grossProfit" placeholder="售价毛利" disabled/>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    autoPrice(form) {
      ...
      form.exclTaxPrice = (form.inclTaxPrice  / (1 + form.vatRate / 100)).toFixed(2);
      form.taxAmount = (form.inclTaxPrice * form.vatRate / 100).toFixed(2);
      form.grossProfit = (form.inclTaxPrice - form.costPrice).toFixed(2);
    }
  }
};
</script>
